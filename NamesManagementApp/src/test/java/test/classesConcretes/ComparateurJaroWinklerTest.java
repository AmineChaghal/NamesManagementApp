...
public class ComparateurJaroWinklerTest {
    ...
    public static void main(String[] args) {
        ...
        if (Math.abs(resultat1 - expected1) < 0.0001f && resultat1 == 1.0f) {
        ...
        if (Math.abs(resultat4 - expected4) < 0.0001f && resultat4 < 1.0f) {
        ...
        if (Math.abs(resultat5 - expected5) < 0.0001f && resultat5 == 0.0f) {
        ...
        if (Math.abs(resultat6 - expected6) < 0.0001f && resultat6 == 1.0f) {
