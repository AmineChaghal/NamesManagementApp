...
public class ComparateurDifferentesCombinaisonsDuNomDecomposeTest {
    ...
    public static void main(String[] args) {
        ...
        if (resultat3 == 0.5f) { // (1/2 * (1+0)) ou (1/2 * (0+1))
            System.out.println("ComparateurDifferentesCombinaisonsTest - Cas 3 (partie commune, tailles diff): Succès. Score: " + resultat3);
        } else {
            System.err.println("ComparateurDifferentesCombinaisonsTest - Cas 3 (partie commune, tailles diff): Échec. Attendu: 0.5, Obtenu: " + resultat3);
        }
        ...
        if (Math.abs(resultat6 - (2.0f/3.0f)) < 0.0001f) {
            System.out.println("ComparateurDifferentesCombinaisonsTest - Cas 6 (correspondance partielle): Succès. Score: " + resultat6);
        } else {
            System.err.println("ComparateurDifferentesCombinaisonsTest - Cas 6 (correspondance partielle): Échec. Attendu approx: " + (2.0f/3.0f) + ", Obtenu: " + resultat6);
        }
    }
}
